...
from .serializers import QuestionSerializer, AnswerSerializer, UserSerializer, StepsSerializer, ResultSerializer
...
class UserResView(viewsets.ViewSet):
    ...
    def list(self, request):
        ...
        res = Result.objects.get(name=top_fac)

        return Response(ResultSerializer(res).data)
